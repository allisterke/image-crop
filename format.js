 ...
 *
 * klavika-web:
 *   - http://typekit.com/eulas/00000000000000003b9acdf9
 *   - http://typekit.com/eulas/00000000000000003b9acdfa
 * source-code-pro:
...
window.Typekit.config = {
    "a": "610279",
    "c": [".tk-klavika-web", "\"klavika-web\",sans-serif", ".tk-source-code-pro", "\"source-code-pro\",sans-serif"],
    "dl": "AAAAygAAAArnD9LQNltzXYBMRKGd6Xbihda9HhnQ+NsAAACA",
    "f": "//use.typekit.net/c/3c2d93/1w;klavika-web,2,2clyrp:W:i7,2clyrn:W:n7;source-code-pro,2,glz:W:n4,gm5:W:n7/{format}{/extras*}",
    "fc": [{
        "id": 7079,
        "family": "klavika-web",
        "src": "{scheme}://{hostname}/af/83c7d4/00000000000000003b9acdf9/27/{format}{?primer,subset_id,fvd}",
        "descriptors": {"weight": "700", "style": "normal", "subset_id": 2}
    }, {
        "id": 7080,
        "family": "klavika-web",
        "src": "{scheme}://{hostname}/af/b9c314/00000000000000003b9acdfa/27/{format}{?primer,subset_id,fvd}",
        "descriptors": {"weight": "700", "style": "italic", "subset_id": 2}
    }, {
        "id": 17451,
        "family": "source-code-pro",
        "src": "{scheme}://{hostname}/af/269954/0000000000000000000179d5/27/{format}{?primer,subset_id,fvd}",
        "descriptors": {"weight": "700", "style": "normal", "subset_id": 2}
    }, {
        "id": 17454,
        "family": "source-code-pro",
        "src": "{scheme}://{hostname}/af/9b5d7b/0000000000000000000179cf/27/{format}{?primer,subset_id,fvd}",
        "descriptors": {"weight": "400", "style": "normal", "subset_id": 2}
    }],
    "fi": [7079, 7080, 17451, 17454],
    "fn": ["klavika-web", ["i7", "n7"], "source-code-pro", ["n4", "n7"]],
    "hn": "use.typekit.net",
    "ht": "tk",
    "js": "1.18.0",
    "kt": "wde1aof",
...
/*{"k":"1.18.0","auto_updating":true,"last_published":"2016-05-03 04:29:51 UTC"}*/
;(function (window, document, undefined) {
    ...
    function ia() {
        this.P = this.R = this.I = this.L = this.M = !0
    };
    function ja(a) {
        this.g = a || "-"
    }
    ...
    function ka() {
        var a = [{name: "font-family", value: u.c[v + 1]}];
        this.g = [u.c[v]];
        this.b = a
    }
    ...
    na.prototype.has = function (a) {
        ...
        for (var b = "number" === typeof a, c = 0; c < this.m; c++) {
            var d;
            if (b)d = w(a & 4294967295, 3432918353), d = d << 15 | d >>> 17, d = w(d, 461845907), d ^= oa[c] || 0, d = d << 13 | d >>> 19, d = w(d, 5) + 3864292196, d ^= 4, d ^= d >>> 16, d = w(d, 2246822507), d ^= d >>> 13, d = w(d, 3266489909), d ^= d >>> 16, d = (d >>> 0) % this.b; else {
                d = oa[c] || 0;
                var e, f, g = a.length % 4, n = a.length - g;
    ...
    function B(a) {
        if (a.m) {
            var b = ta(a.g, a.b.b("wf", "active")), c = [], d = [a.b.b("wf", "loading")];
    ...
    function C(a, b, c) {
        if (a.A && a.o[b])try {
            if (c)a.o[b](c.b, D(c)); else a.o[b]()
        } catch (d) {
            console.error('Typekit: Error in "' + b + '" callback', d)
        }
        if (a.w[b])if (c)a.w[b](c.b, D(c)); else a.w[b]()
    };
    function wa(a, b, c) {
        c = c || {};
        this.b = a;
    ...
    function E(a, b) {
        return new wa(b, a.g, {weight: a.weight, style: a.style, N: a.N, O: a.O})
    }
    ...
    function Ea(a, b) {
        for (var c = [], d = 0; d < b.length; d++) {
            var e = b[d], f = za(new ya(a.g), {
                scheme: "https",
                hostname: "fonts.typekit.net",
                format: e,
                primer: a.N,
                subset_id: a.O,
                fvd: D(a),
            ...
            "i" === e ? c.push("url(" + f + ")") : c.push("url(" + f + ') format("' + Ha(e) + '")')
        }
        return c.join(",")
    }
    ...
    var Oa = {aa: "serif", $: "sans-serif"}, Pa = null;

    function Qa() {
        if (null === Pa) {
            var a = /AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent);
            Pa = !!a && (536 > parseInt(a[1], 10) || 536 === parseInt(a[1], 10) && 11 >= parseInt(a[2], 10))
        }
        return Pa
    }
    ...
    function Sa(a, b, c) {
        for (var d in Oa)if (Oa.hasOwnProperty(d) && b === a.g[Oa[d]] && c === a.g[Oa[d]])return !0;
        return !1
    }

    function Ra(a) {
        var b = a.m.b.offsetWidth, c = a.o.b.offsetWidth, d;
    ...
    Va.prototype.start = function () {
        var a = this.w.g.document, b = this, c = k(), d = new Promise(function (d, e) {
            function n() {
                k() - c >= b.g ? e() : a.fonts.load(b.b.style + " " + b.b.weight + " 300px " + (b.o ? xa(b.b) : b.b.b), b.A).then(function (a) {
    ...
    function Ya(a, b, c) {
        ...
        if (!e && c)B(a.b); else {
            ...
            Ca(b, function (b) {
                ...
                C(c, "fontloading", b);
                c = null;
                if (null === Xa)if (window.FontFace) {
                    var e = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent);
                    Xa = e ? 42 < parseInt(e[1], 10) : !0
                } else Xa = !1;
    ...
    Wa.prototype.o = function (a) {
        var b = this.b;
        if (b.m) {
            var c = ta(b.g, b.b.b("wf", a.b, D(a), "active")), d = [], e = [b.b.b("wf", a.b, D(a), "loading")];
    ...
    function Za(a) {
        !--a.g && a.w && (a.A ? (a = a.b, a.m && z(a.g, [a.b.b("wf", "active")], [a.b.b("wf", "loading"), a.b.b("wf", "inactive")]), C(a, "active")) : B(a.b))
    };
    function G(a) {
        return "Windows" === a.v
    }
    ...
    function $a(a) {
        return G(a) && q(a.u, new l(6, 1))
    }

    function H(a) {
        return G(a) && r(a.u, new l(5, 1)) || G(a) && r(a.u, new l(5, 2)) || G(a) && r(a.u, new l(6, 0)) || $a(a)
    }

    function I(a) {
        return "Macintosh" === a.v && (q(a.u, new l(10, 4)) || null === a.u.b)
    }

    function ab(a, b) {
        return b.M && ("iPhone" === a.v || "iPod" === a.v) && q(a.u, new l(4, 2)) && p(a.u, new l(5))
    }

    function bb(a, b) {
        return b.M && ("iPhone" === a.v || "iPod" === a.v) && q(a.u, new l(5))
    }

    function cb(a, b) {
        return b.L && "iPad" === a.v && q(a.u, new l(4, 2)) && p(a.u, new l(5))
    }

    function db(a, b) {
        return b.L && "iPad" === a.v && q(a.u, new l(5))
    }
    ...
    function eb(a, b) {
        return J(a, b) && q(a.u, new l(2, 2)) && p(a.u, new l(3, 1))
    }

    function fb(a, b) {
        return J(a, b) && q(a.u, new l(3, 1)) && p(a.u, new l(4, 1))
    }
    ...
    var gb = {
        a: function (a, b) {
            ...
            return ha(a) && fb(a, b) || b.I && "Silk" === a.getName() && q(a.C, new l(2)) && (fb(a, b) || L(a))
        }, i: function (a) {
            return "MSIE" === a.getName() && q(a.C, new l(6, 0)) && (void 0 === a.K || 9 > a.K) && H(a)
        }, l: function (a, b) {
            return ga(a) && (H(a) || L(a) || I(a) || J(a, b) || "CrOS" === a.v || "CrKey" === a.v) || "Gecko" === a.H && q(a.G, new l(39)) && (H(a) || L(a) || I(a) || J(a, b)) || "Opera" === a.getName() && q(a.C, new l(23)) && (H(a) || L(a) || I(a) || J(a, b))
        },
        x: function () {
            return !1
        }
    ...
    hb.prototype.supportsConfiguredBrowser = function () {
        return "x" !== this.g
    };
    hb.prototype.init = function () {
        if (0 < this.m.length) {
            for (var a = [], b = 0; b < this.m.length; b++)a.push(la(this.m[b]));
            A(this.b, a.join(""))
        }
    };
    hb.prototype.load = function (a, b, c) {
        ...
        c = c || {};
        a = c.timeout;
        var e = !!c.async, f = Da(this.A, this.g);
        c = new va(this.b, c, {
            active: function () {
                if (e) {
                    var a = Ja(f, d.g, !1);
                ...
                if (d.D) {
                    var a = d.D, b = d.b, c = new ya("{scheme}://{hostname}/p.gif{?s,k,app,ht,h,f,a,js,_}"), g = (window.__adobewebfontsappname__ || a.app || "").toString().substr(0, 20), b = b.g.location.hostname || b.m.location.hostname, n = [], P = [];
                    ...
                    for (var Q = 0; Q < a.b.length; Q++) {
                        for (var kb = !1, Ga = 0; Ga < P.length; Ga++)if (a.b[Q] === P[Ga]) {
                            kb = !0;
                            break
                        }
    ...
    jb.prototype.load = function (a, b) {
        ...
        if (c.length)for (var e = this, f = c.length, g = 0; g < c.length; g++)lb(this, c[g], function () {
            --f || mb(e, d)
        }); else mb(this, d)
    };
    function lb(a, b, c) {
    ...
    function mb(a, b) {
        if (a.b.length) {
            for (var c = new va(a.g, b, {}), d = !1, e = 0; e < a.b.length; e++)a.b[e].init(), d = d || a.b[e].supportsConfiguredBrowser();
            if (d)for (c.m && z(c.g, [c.b.b("wf", "loading")]), C(c, "loading"), c = 0; c < a.b.length; c++)d = a.b[c], d.supportsConfiguredBrowser() && d.load(null, c == a.b.length - 1, b); else B(c);
            a.b = []
        }
    };
    function ib(a) {
    ...
    function R(a) {
        ...
        if (b = O(a.b, /(?:Linux|CrOS|CrKey) ([^;)]+)/, 1))for (var b = b.split(/\s/), c = 0; c < b.length; c += 1)if (/^[\d\._]+$/.test(b[c]))return b[c];
        return (a = O(a.b, /(BB\d{2}|BlackBerry).*?Version\/([^\s]*)/, 2)) ? a : "Unknown"
    }

    function ob() {
        var a = S, b = "Unknown", c = t(O(a.b, /Presto\/([\d\w\.]+)/, 1)), d = t(R(a)), e = T(a.g);
    ...
    function pb() {
        var a = S, b = N(a), c = t(R(a)), d = t(O(a.b, /AppleWeb(?:K|k)it\/([\d\.\+]+)/, 1)), e = "Unknown", f;
        f = "Unknown";
    ...
    var qb, S = new function () {
        var a = document;
        this.b = navigator.userAgent;
        this.g = a
    }, rb;
    if (-1 != S.b.indexOf("MSIE") || -1 != S.b.indexOf("Trident/")) {
        var U = S, sb = N(U), tb = t(R(U)), ub, vb, wb, xb = O(U.b, /Trident\/([\d\w\.]+)/, 1), yb = T(U.g);
        ub = -1 != U.b.indexOf("MSIE") ? t(O(U.b, /MSIE ([\d\w\.]+)/, 1)) : t(O(U.b, /rv:([\d\w\.]+)/, 1));
        "" !== xb ? (vb = "Trident", wb = t(xb)) : (vb = "Unknown", wb = new l);
        rb = new M("MSIE", ub, vb, wb, sb, tb, yb)
    } else {
        var zb;
        if (-1 != S.b.indexOf("Edge/")) {
            var Ab = S, Bb = N(Ab), Cb = t(R(Ab)), Db = t(O(Ab.b, /Edge\/([\d\w\.]+)/, 1));
            zb = new M("Edge", Db, "Edge", Db, Bb, Cb, T(Ab.g))
        } else {
            var Eb;
            if (-1 != S.b.indexOf("Opera"))Eb =
                ob(); else {
                var Fb;
                if (/OPR\/[\d.]+/.test(S.b))Fb = pb(); else {
                    var Gb;
                    if (/AppleWeb(K|k)it/.test(S.b))Gb = pb(); else {
                        var Hb;
                        if (-1 != S.b.indexOf("Gecko")) {
                            var V = S, Ib = "Unknown", Jb = new l, Kb = t(R(V));
                            -1 != V.b.indexOf("Firefox") ? (Ib = "Firefox", Jb = t(O(V.b, /Firefox\/([\d\w\.]+)/, 1))) : -1 != V.b.indexOf("Mozilla") && (Ib = "Mozilla");
                            var Lb = t(O(V.b, /rv:([^\)]+)/, 1));
                            Hb = new M(Ib, Jb, "Gecko", Lb, N(V), Kb, T(V.g))
                        } else Hb = nb;
                        Gb = Hb
                    }
                    Fb = Gb
    ...
    if (!window.Typekit.load) {
        var Nb = new jb(new ya("//" + (window.Typekit.config || {}).hn + "/{id}.js"), Mb);
        window.Typekit.load = function () {
            Nb.load.apply(Nb, arguments)
        };
        window.Typekit.addKit = function () {
            Nb.m.apply(Nb, arguments)
        }
    }
    var W, X, u = window.Typekit.config || {};
    X = new hb(Mb);
    X.D = new function () {
        var a = u.ps, b = u.ht, c = u.fi, d = u.a, e = u.kt, f = u.js, g = u.l;
        this.A = u.p;
        this.o = a;
        this.m = b;
        this.b = c || [];
    ...
    W.P = !u.sb;
    X.w = W;
    if (u.fc)for (var Ob = u.fc, Y = 0; Y < Ob.length; Y++)X.A.b.push(new wa(Ob[Y].family, Ob[Y].src, Ob[Y].descriptors));
    if (u.dl) {
        var Pb = u.dl;
        try {
            X.o = new pa(Pb)
    ...
    u.kt && (X.B = u.kt);
    u.hn && (X.J = u.hn);
    if (u.c)for (var v = 0; v < u.c.length; v += 2)X.m.push(new ka);
    X.F = qb;
    var Qb;
    a:{
        var Rb = X.F, Sb = new ia, Tb = X.w || Sb, Ub;
        for (Ub in F) {
            var Z = F[Ub];
            if (gb[Z] && gb[Z](Rb, Tb)) {
                Qb = Z;
        ...
        for (Ub in F)if (Z = F[Ub], gb[Z] && gb[Z](Rb, Sb)) {
            Qb = "x";
            break a
        }
        Qb = "k"
        ...
        window.Typekit.load = function (a) {
            ...
            a.fontactive = function (a, b) {
                ...
                a:{
                    ...
                    /[1-9]/.test(n) || (n = 4);
                    n += "00";
                    for (var y = u.fc, K = 0; K < y.length; K++)if (y[K].family === a && y[K].descriptors.weight === n && y[K].descriptors.style === g) {
                        g = y[K].id;
                        break a
                    }
                    g = 0
